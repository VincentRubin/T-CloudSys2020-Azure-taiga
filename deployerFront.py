# -*- coding: utf-8 -*-
"""
Created on Mon Oct  5 21:05:33 2020

@author: vincent.rubin

This script come from : https://docs.microsoft.com/en-us/samples/azure-samples/resource-manager-python-template-deployment/resource-manager-python-template-deployment/
...
class Deployer(object):
    ...
    def deploy(self):
        ...
        template_path = os.path.join(os.path.dirname(__file__), 'taigaFront', 'template.json')
